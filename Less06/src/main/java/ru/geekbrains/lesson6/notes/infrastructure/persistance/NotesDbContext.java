...
public class NotesDbContext extends DbContext
        implements NotesDatabaseContext {
    ...
    public Collection<Note> getAll() {
        ...
        //TODO: Этого кастинга быть не должно,
        // тут должен работать внутренний механизм фреймворка
